      ...
      <div style={{minHeight: '100vh', background: '#f9fafb'}}>
        ...
        <div style={{padding: '2rem', maxWidth: '1200px', margin: '0 auto'}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem'}}>
            {[
              { label: 'New Enrollment', icon: '➕', color: '#f97316' },
              { label: 'Send Message', icon: '✉️', color: '#3b82f6' },
              { label: 'View Students', icon: '🎒', color: '#8b5cf6' },
              { label: 'Reports', icon: '📊', color: '#10b981' },
            ].map((action) => (
              <button key={action.label} style={{background: 'white', border: `2px solid ${action.color}`, borderRadius: '1rem', padding: '1.25rem', cursor: 'pointer', textAlign: 'left', boxShadow: '0 1px 4px rgba(0,0,0,0.08)'}}>
